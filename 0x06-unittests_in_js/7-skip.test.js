...
describe('Testing numbers', () => {
  it('1 is equal to 1', () => expect(1 === 1).to.be.true);

  it('2 is equal to 2', () => expect(2 === 2).to.be.true);
  // for example: skip if API is down or test is unstable
  it.skip('1 is equal to 3', () => expect(1 === 3).to.be.true);
  ...
  it('7 is equal to 7', () => expect(7 === 7).to.be.true);
});
